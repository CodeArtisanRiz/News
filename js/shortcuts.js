...
function display() {
    document.querySelector(".links-container").innerHTML = '<div class="col-2 order-2 my-2 addBtn"><a href="#Add_Doctors" data-toggle="modal" class="btn"><img src="icons/plus.svg" alt="" width="30"></a><!-- <input type="button" class="searchButton btn btn-primary float-right" onclick="addElement()" value="Add"> --></div>';
    for (var i = 0; i < elements.length; i++)
        document.querySelector(".links-container").innerHTML +=
        "<div class='col-2 my-2 stored-links'>" +
            "<a class='tile' href='https://" + elements[i][1] + "'>" +
                "<div class='tile-icon'>" + 
                    "<img width='25' height='25' src='" + elements[i][2] + "'>" + 
                "</div>" + 
            "</a>" +
